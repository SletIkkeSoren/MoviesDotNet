...
namespace Movies.Controllers
{
    public class ActorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ActorId,ActorName,ActorAge")] Actor actor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ActorId,ActorName,ActorAge")] Actor actor)
        {
            if (id != actor.ActorId)
            {
                return NotFound();
